...
- **Fleet State Outlier Rejection Fixed**: Multi-user tracker candidates were incorrectly being compared to each other as a trajectory sequence, falsely rejecting active pingers as teleports due to near-zero timestamp deltas across independent clients. This resolves the "sole radar" immunity issue when multiple people are clustered on the same bus.
